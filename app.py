...
TASK_GRADERS = {
    ...
    "storm_front_response": "server.graders.grade_storm_front_response",
    "winter_gas_shortage": "server.graders.grade_winter_gas_shortage",
}
        ...
        tasks.append(
            {
                ...
                "grader": TASK_GRADERS.get(task_id, "server.graders.grade_weekday_spike"),
            }
        )
    return {"tasks": tasks}
